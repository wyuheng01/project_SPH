        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <!-- 以前路由跳转，从A路由跳转到B路由，这里在加入购物车，进行路由跳转之前，发请求，把你购买的产品信息通过请求的形式通知服务器，服务器进行相应的存储-->
...
export default {
  ...
  methods: {
    ...
    async addShopcar() {
      ...
      //判断加入购物车是成功还是失败,进行相应的操作,下面这行代码目的是调用仓库中的 addOrUpdateShopCart
      try {
        await this.$store.dispatch('addOrUpdateShopCart', {skuId: this.$route.params.skuId, skuNum: this.skuNum})
        //  路由跳转
        //一节简单的数据skuNum，通过query形式给路由组件传递过去
